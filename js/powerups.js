...
function PowerUp(
  ...
  if (typeof functionName == "string") this.functionName = [functionName];
  else if (!functionName) this.functionName = [];
  else this.functionName = functionName;
...
FlyPowerUp.prototype = new PowerUp("\uf072 Fly", "fly.mp3", 600, [
  "isInWater",
  "drawTail",
]);
FlyPowerUp.prototype.isInWater = function () {
  return true;
};
...
FastPowerUp.prototype.tailDivideFactor = 0.3;
...
InvinciblePowerUp.prototype = new PowerUp(
  "\uf005 Invincible",
  "invincible.mp3",
  500,
  ["getColor", "distanceTo"],
...
PacManPowerUp.prototype = new PowerUp("\uf118 PacMan", "pacman.mp3", 100, [
  "drawBody",
  "edible",
]);
...
TimeStopPowerUp.prototype = new PowerUp(
  "\uf017 Time Stop",
  "timestop.mp3",
  300,
);
...
SuperPowerUp.prototype.tailDivideFactor =
  FastPowerUp.prototype.tailDivideFactor;
SuperPowerUp.prototype.tailLengthenFactor =
  FastPowerUp.prototype.tailLengthenFactor;
